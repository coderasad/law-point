    ...
    <div class="container-fluid">       
        <div class="row"> 
            ...
            <div class="col-md-10 mb-2 mt-3">
                <h4 class="text-center radius bg-primary text-white p-2 text-uppercase">Edit Service Section</h4>
            </div> 
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form class="" action="{{ url('service/'.$db->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('patch')
                            ...
                            <div class="row form-group">
                                ...
                                <textarea class="form-control col-6 textarea" maxlength="110" id="description" name="description">{{$db->description}}</textarea>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="custom-file col-6">                                
                                    ...
                                    <input value="public/frontend/images/service/{{ $db->img }}" name="old_img" type="hidden" >
                                    <div class="text-danger ">Image must be width: <b>480px</b> and height: <b>380px</b></div>                                    
                                </div>
                                <div class="col-4 offset-2 mt-4">
                                    <img src="../../public/frontend/images/service/{{ $db->img }}" id="img_show" width="80"/>    
                                </div>
                            </div>                          
                            <div class="row form-group">
