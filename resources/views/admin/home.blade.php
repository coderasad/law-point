...
@php
    $myStyle =[
        "http://localhost/a/law_point/public/backend/plugins/metro/MetroJs.min.css",
        "http://localhost/a/law_point/public/backend/plugins/morris/morris.css",
        "http://localhost/a/law_point/public/backend/plugins/jvectormap/jquery-jvectormap-2.0.2.css"
    ];
    $myScript = [
        'http://localhost/a/law_point/public/backend/plugins/metro/MetroJs.min.js',    
        'http://localhost/a/law_point/public/backend/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js',   
        'http://localhost/a/law_point/public/backend/plugins/jvectormap/jquery-jvectormap-world-mill-en.js',   
        'http://localhost/a/law_point/public/backend/plugins/sparkline-chart/jquery.sparkline.min.js', 
        'http://localhost/a/law_point/public/backend/plugins/morris/morris.min.js',    
        'http://localhost/a/law_point/public/backend/plugins/raphael/raphael-min.js',  
        'http://localhost/a/law_point/public/backend/pages/dashboard.js'
    ];
@endphp
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card">
                                    <div class="card-body text-center">
                                        <img src="{{asset('public/backend/images/flags/us_flag.jpg')}}" alt="" class="w-30">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <img src="{{asset('public/backend/images/flags/russia_flag.jpg')}}" alt="" class="w-30">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img class="rounded-circle" src="{{asset('public/backend/images/users/avatar-1.jpg')}}" alt="user" width="40"> 
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded-circle w-50" src="{{asset('public/backend/images/users/avatar-2.jpg')}}" alt="user"> </td>
                                        <td>
                                            <a href="javascript:void(0);" class="text-dark">William A. Johnson</a>
                                        </td>
                                        <td>28/05/2018 9:20 AM</td>
                                        <td>                                                                
                                            <img src="{{asset('public/backend/images/flags/french_flag.jpg')}}" alt="" class="w-30">
                                        </td>
                                        <td>2643BZ</td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded-circle w-50" src="{{asset('public/backend/images/users/avatar-3.jpg')}}" alt="user"> </td>
                                        <td>
                                            <a href="javascript:void(0);" class="text-dark">Bobby M. Gray</a>
                                        </td>
                                        <td>3/05/2018 8:45 PM</td>
                                        <td>                                                                
                                            <img src="{{asset('public/backend/images/flags/spain_flag.jpg')}}" alt="" class="w-30">
                                        </td>
                                        <td>2458DA</td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded-circle w-50" src="{{asset('public/backend/images/users/avatar-4.jpg')}}" alt="user"> </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded-circle w-50" src="{{asset('public/backend/images/users/avatar-5.jpg')}}" alt="user" > 
                                        </td>
                                        <td>
                                        ...
                                        <td>                                                                
                                            <img src="{{asset('public/backend/images/flags/italy_flag.jpg')}}" alt="" class="w-30">
                                        </td>
                                        <td>4451CA</td>
                                        <td><span class="badge badge-boxed badge-warning">Pending</span></td> 
                                    </tr>                                                      
