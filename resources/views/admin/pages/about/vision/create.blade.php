    ...
    <div class="container-fluid">       
        <div class="row">
            ...
            <div class="col-10 mb-2 mt-3">
                <h4 class="text-center radius bg-primary text-white p-2 text-uppercase">Add Vision Section</h4>
            </div>  
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form class="" action="{{URL::to('vision')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row form-group">
                                <label for="title" class="col-2">Vision Title</label>
                                <input class="form-control col-6 placement"  maxlength="30" id="title" name="title" type="text" placeholder="Vision Title" >
                            </div>
                            <div class="row form-group">
                                <label for="description" class="col-2">Vision Description</label>
                                <textarea name="description" id="description" class="form-control col-6 textarea"  maxlength="460" laceholder="Description Here..." rows="6" placeholder="Vision Description..."></textarea>
                            </div>
                            <div class="row form-group">
