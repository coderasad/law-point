    ...
    <div class="container-fluid">       
        <div class="row">
            ...
            <div class="col-md-10 mb-2 mt-3">
                <h4 class="text-center radius bg-primary text-white p-2 text-uppercase">Edit Mission Section</h4>
            </div>       
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form class="" action="{{ url('mission/'.$db->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('patch')
